...
def addHairAtrr():
    for hair in hairs_list:
        ...
        # UV ATTR SECTION
        addAttr(sn='sus1', ln='strip_uv_scale_1', at = 'float')
        setAttr(str(hair)+'.sus1', 1)
        addAttr(sn='sus2', ln='strip_uv_scale_2', at = 'float')
        setAttr(str(hair)+'.sus2', 1)
        addAttr(sn='sus3', ln='strip_uv_scale_3', at = 'float')
        setAttr(str(hair)+'.sus3', 1)
        addAttr(sn='sus4', ln='strip_uv_scale_4', at = 'float')
        setAttr(str(hair)+'.sus4', 1)
        addAttr(sn='sus5', ln='strip_uv_scale_5', at = 'float')
        setAttr(str(hair)+'.sus5', 1)
        addAttr(sn='sush', ln='strip_uv_scale_horizontal', at = 'float')
        setAttr(str(hair)+'.sush', 1)
        
        addAttr(sn='sut1', ln='strip_uv_trans_1', at = 'float')
        setAttr(str(hair)+'.sut1', 1)
        addAttr(sn='sut2', ln='strip_uv_trans_2', at = 'float')
        setAttr(str(hair)+'.sut2', 1)
        addAttr(sn='sut3', ln='strip_uv_trans_3', at = 'float')
        setAttr(str(hair)+'.sut3', 1)
        addAttr(sn='sut4', ln='strip_uv_trans_4', at = 'float')
        setAttr(str(hair)+'.sut4', 1)
        addAttr(sn='sut5', ln='strip_uv_trans_5', at = 'float')
        setAttr(str(hair)+'.sut5', 1)
        addAttr(sn='suth', ln='strip_uv_trans_horizontal', at = 'float')
        setAttr(str(hair)+'.suth', 1)
...
def transformHairsUVs(*args):
    ...
    for uvs in hairs_uvs_list:
        ...
        # SCALE HORIZONTAL
        polyEditUVShell( pu=0.5, pv=0.1, su=0.5)
    select( clear = True)
